...
export const projects: ProjectLab[] = [
  ...
  },
  {
    ...
    status: 'Cas d’usage vocal + CRM en validation',
    problem: 'Dans l’immobilier, les demandes entrantes peuvent perdre de la valeur si la qualification, le suivi et le transfert vers le bon courtier ne sont pas structurés.',
    goal: 'Bâtir un assistant vocal et un système de suivi qui qualifient les prospects, résument les besoins et gardent une trace exploitable dans le CRM.',
    stack: ['VAPI', 'n8n', 'Supabase', 'CRM', 'Scripts de qualification', 'Relances automatisées'],
    learning: 'Un agent vocal business n’est pas seulement un bot : il faut un playbook clair, des statuts fiables, une logique d’escalade humaine et des garde-fous sur les données.',
    nextStep: 'Clarifier publiquement ce qui peut être montré sans exposer de données client, puis transformer le cas en fiche pédagogique sur la qualification IA.',
    resource: 'Playbook agent vocal immobilier + structure prospects/relances Next Move',
  },
];
